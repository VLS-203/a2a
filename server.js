...
function buildHomepage(agents) {
 ...
 const agentList = agents.map(a => {
   ...
   return `<div class="agent-entry"><div class="col-name">${a.name}</div><div class="col-cat">${a.primaryCategory || 'Agent'}</div><div class="col-use" title="${howUse}">${howUse}</div><div class="col-io">${ioCol}</div><div class="col-protocols">${protocols}</div><div class="col-payments">${paymentBadges}</div><div class="col-trust">${countryFlag} ${osBadge} ${certBadges} ${trustBadge}</div></div>`;
 }).join('');
